C
C     dopri5_nocommon.f: This is a reentrant version of dopri5.f, with
C     COMMON blocks removed and RECURSIVE directives added. The call
C     signatures for CONTD5 and SOLOUT are different than in dopri5.f.
C
      RECURSIVE
...
C                 THE FUNCTION
C                        >>>   CONTD5(I,S,CON,ICOMP,ND,XOLD,H)   <<<
...
C
      RECURSIVE
     &FUNCTION CONTD5(II,X,CON,ICOMP,ND,XOLD,H)
C ----------------------------------------------------------
